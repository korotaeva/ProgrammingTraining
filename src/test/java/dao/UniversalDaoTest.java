...
public abstract class UniversalDaoTest<Context> {
     ...
     */
    public abstract UniversalDao dao();
    ...
    public void testPersist() throws Exception {
        ...
        notPersistedDto = dao().createByObject(notPersistedDto);
    ...
    public UniversalDaoTest(Class clazz, Identified<Integer> notPersistedDto) {
        this.daoClass = clazz;
